...
public class Paper {
     ...
     * 个体包含的试题集合
     */
    private List<TbQuestions> questionList = new ArrayList<TbQuestions>();
    ...
    public double getTotalScore() {
        if (totalScore == 0) {
            double total = 0;
            for (TbQuestions question : questionList) {
...
////          Set<String> another = questionList.stream().map(TbQuestions -> String.valueOf(TbQuestions.getPointid())).collect(Collectors.toSet());
//            Set<String> another = questionList.stream().map(TbQuestions -> String.valueOf(TbQuestions.getPointid())).collect(Collectors.toSet());
//            // 交集操作
...
//    }
    ...
    public boolean containsQuestion(TbQuestions question) {
        if (question == null) {
            ...
            for (TbQuestions aQuestionList : questionList) {
     ...
     * @param question
     */
    public void saveQuestion(int index, TbQuestions question) {
    ...
    public void addQuestion(TbQuestions question) {
    ...
    public TbQuestions getQuestion(int index) {
    ...
    public void setQuestionList(List<TbQuestions> questionList) {
